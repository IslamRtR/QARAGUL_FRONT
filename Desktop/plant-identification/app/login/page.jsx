...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ general: "Кіру кезінде қате орын алды. Email немесе құпия сөзді тексеріңіз." })
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl text-center">Қош келдіңіз!</CardTitle>
            <CardDescription className="text-center">Өз аккаунтыңызға кіріңіз</CardDescription>
          </CardHeader>
          <CardContent>
            {successMessage && (
